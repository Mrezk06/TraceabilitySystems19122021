    ...
    Private Sub OK_Click(sender As Object, e As EventArgs) Handles OK.Click
        Try
            ...
            ElseIf UsernameTextBox.Text = "o" And PasswordTextBox.Text = "0" Then
                ...
                frm.Show()
                Me.Hide()
                'ElseIf UsernameTextBox.Text = "admin" And PasswordTextBox.Text = "0" Then
                '    Dim frm As New frmMainWashingMachine
                '    frm.Show()
                '    Me.Hide()
            ElseIf UsernameTextBox.Text = "FG_MFG" And PasswordTextBox.Text = "0" Then
