...
Public Class frmWashingMachineStepOutput
    ...
    Private Function _Refresh1() As Boolean
        Try
            ...
            ds.Tables("WMQueryData").Columns(0).ColumnName = "الموديل "
            ds.Tables("WMQueryData").Columns(1).ColumnName = " الكمية"
            dg2.DataSource = ds.Tables("WMQueryData")
            Return True
    ...
    Private Function _Refresh1777() As Boolean
        Try
            ...
            sql += " FROM WashingMachineStepOutput "
            sql += " WHERE H_date >= Convert(nvarchar(10), GETDATE(), 121)"
            sql += " and H_Shift_Line=" & txtshift.Text & ""
            '    sql += " and fLCDPline ='" & txtline.Text & "'"
        ...
        Try
            If e.KeyCode = Keys.Enter Then
                ...
                If e.KeyCode = Keys.Enter Then
                    ...
                    Dim Sql1 = "Select H_Heater_Code from WashingMachineStepOutput where H_Heater_Code='" & txtBarcodeOne.Text & "'"
    ...
    Private Sub TxtheaterThree_KeyDown(sender As Object, e As KeyEventArgs) Handles TxtheaterThree.KeyDown
        Try
            If e.KeyCode = Keys.Enter Then
                ...
                If TxtheaterThree.Text = txtPARTSSERIAL.Text Then

                    Dim sql6 As String
                    sql6 = "INSERT INTO WashingMachineStepOutput"
    ...
    Private Sub btnSEARCH_Click(sender As Object, e As EventArgs) Handles btnSEARCH.Click
        Dim frm As New frmWashingMachineStepQuery
        frm.Show()
        ...
        Try
            ...
            If e.KeyCode = Keys.Enter Then
                ...
                Else
                    ...
                    lbl_Msg.ForeColor = Color.GreenYellow
                    lbl_Msg.Text = "الايان كود الاول مطابق للموديل"
    ...
    Private Sub frmWashingMachineStepOutput_Load(sender As Object, e As EventArgs) Handles MyBase.Load
