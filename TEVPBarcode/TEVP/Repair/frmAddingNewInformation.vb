...
Public Class frmAddingNewInformation
    Private Function Add1_New() As Boolean
        Try
            Dim sql As String
            sql = "	INSERT INTO R_Name_Problems "
    ...
    Private Function Del_Rec() As Boolean
        Try
            Dim sql As String
            sql = "	DELETE FROM R_Name_Problems"
    ...
    Private Function Update1A() As Boolean
        Try
            Dim sql As String
            sql = " UPDATE  R_Name_Problems set"
    ...
    Private Function Add1_New1() As Boolean
        Try
            Dim sql As String
            sql = "	INSERT INTO R_Reson_Problems "
            sql += "( R_SN, R_Name_Problem)"
    ...
    Private Function Del_Rec1() As Boolean
        Try
            Dim sql As String
            sql = "	DELETE FROM R_Reson_Problems"
    ...
    Private Function Update11A() As Boolean
        Try
            Dim sql As String
            sql = " UPDATE  R_Reson_Problems set"
    ...
    Private Function _Refresh11() As Boolean
        Try
            ...
            Dim sql1 As String = "SELECT R_SN, R_Name_Problem FROM R_Reson_Problems"
            ' sql1 += "   where fLCDModelName ='" & txtModel.Text & "'"
            Dim da As New SqlClient.SqlDataAdapter(sql1, cn)
            Dim ds As New DataSet
            da.Fill(ds, "R_Reson_Problems")
            ds.Tables("R_Reson_Problems").Columns(0).ColumnName = "Code"
            ds.Tables("R_Reson_Problems").Columns(1).ColumnName = "reason Name"
            ' ds.Tables("LCDTVModels").Columns(2).ColumnName = "fpanelID"
            ' ds.Tables("LCDTVModels").Columns(3).ColumnName = "fpanelIDLCM"
            dg.DataSource = ds.Tables("R_Reson_Problems")
    ...
    Private Function _Refresh112() As Boolean
        Try
            ...
            Dim sql1 As String = "SELECT R_Sap, R_Name_Laber, R_Line,R_ID FROM R_Name_Laber1"
            ' sql1 += "   where fLCDModelName ='" & txtModel.Text & "'"
            Dim da As New SqlClient.SqlDataAdapter(sql1, cn)
            Dim ds As New DataSet
            da.Fill(ds, "R_Name_Laber1")
            ds.Tables("R_Name_Laber1").Columns(0).ColumnName = "code"
            ds.Tables("R_Name_Laber1").Columns(1).ColumnName = " Name"
            ds.Tables("R_Name_Laber1").Columns(2).ColumnName = "Line"
            ds.Tables("R_Name_Laber1").Columns(3).ColumnName = "sap"
            ' ds.Tables("LCDTVModels").Columns(3).ColumnName = "fpanelIDLCM"
            dg.DataSource = ds.Tables("R_Name_Laber1")
