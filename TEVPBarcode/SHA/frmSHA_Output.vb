...
Public Class frmSHA_Output
    ...
    Private Function _Refresh1() As Boolean
        Try
            ...
            ds.Tables("SHA_Output_Production").Columns(0).ColumnName = " الموديل "
            ds.Tables("SHA_Output_Production").Columns(1).ColumnName = " الكمية"
            dg2.DataSource = ds.Tables("SHA_Output_Production")
        ...
        If e.KeyCode = Keys.Enter Then
            Try
                ...
                If txtBarcodeOne.Text.Length = 19 Then
                    ...
                    Dim Sql = "Select CBarcode from SHA_Output_Production where CBarcode='" & txtBarcodeOne.Text & "'"
                    Dim da As New SqlClient.SqlDataAdapter(Sql, cn)
                    dsMax.Tables.Clear()
                    da.Fill(dsMax)
                    ...
                    If lbl_Pcode_Value.Text = Barcode_Part(1) Then
                        ...
                        Dim sql2 As String
                        sql2 = "INSERT INTO SHA_Output_Production"
