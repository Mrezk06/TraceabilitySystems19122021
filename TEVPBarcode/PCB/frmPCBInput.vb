...
Public Class frmPCBInput
    ...
    Private Function _Refresh1() As Boolean
        Try
            ...
            dg2.DataSource = ds.Tables("PCBIN")
            Return True
        Catch ex As Exception
        End Try
    End Function
    ...
    Private Sub txtFATSERIAL_KeyDown(sender As Object, e As KeyEventArgs) Handles txtFATSERIAL.KeyDown
        ...
        Try
            ...
            If e.KeyCode = Keys.Enter Then
                If txtFATSERIAL.Text.Length < 18 Then Exit Sub
                Dim dsMax As New DataSet
                Dim Sql = "Select fLCDBarcode from PCBIN where fLCDBarcode='" & txtFATSERIAL.Text & "'"
                Dim da As New SqlClient.SqlDataAdapter(Sql, cn)
                dsMax.Tables.Clear()
                da.Fill(dsMax)
    ...
    Private Sub btnSEARCH_Click(sender As Object, e As EventArgs) Handles btnSEARCH.Click
        Dim frm As New frmQuery_PCB_Input
        frm.Show()
        Me.Hide()
