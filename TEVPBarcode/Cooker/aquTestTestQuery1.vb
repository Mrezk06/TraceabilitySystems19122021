...
Public Class aquTestTestQuery1
    ...
    Private Sub frmResturantQueryUser_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            Dim sql As String = ""
            sql += "SELECT P1 FROM [barcode].[dbo].[C_Atc_3] group by P1"
    ...
    Private Function _Refr2() As Boolean
        Try
            Dim sql As String = ""
            sql += "SELECT  COUNT(P7) AS QTY FROM C_Atc_3"
            ...
            ds.Tables("C_Atc_3").Columns(0).ColumnName = "الكمية"
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Try
            ...
            cn.Open()
            Using sql As New SqlCommand("SELECT P1, P4, P5, P7, P13, P17, P21, P25, P29, P33, DT FROM C_Atc_3 where  DT>= '" & Format(dtpFROMDATE.Value, "yyyy-MM-dd") & "'and DT<= '" & Format(dtpToDATE.Value, "yyyy-MM-dd") & "'", cn)
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        Try
            Dim dt As New DataTable
            cn.Open()
            Using sql As New SqlCommand("SELECT P1, P4, P5, P7, P13, P17, P21, P25, P29, P33, DT FROM C_Atc_3 where  DT>= '" & Format(dtpFROMDATE.Value, "yyyy-MM-dd") & "'and DT<= '" & Format(dtpToDATE.Value, "yyyy-MM-dd") & "' and P1='" & cmb_Pcode.Text & "'", cn)
                Dim da As New SqlDataAdapter
                da.SelectCommand = sql
