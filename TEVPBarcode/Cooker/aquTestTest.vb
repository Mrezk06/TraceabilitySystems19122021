...
Public Class aquTestTest
    ...
    Private Sub Button4_Click(sender As System.Object, e As System.EventArgs) Handles Button4.Click
        Try
            ...
            'tblReadCSV.Columns.Add("P35")
            'tblReadCSV.Columns.Add("P36")
            Dim csvParser As New TextFieldParser("E:\UpLoad.txt")
            ...
            Dim strSql As String = "Insert into C_Atc_1(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20, P21, P22, P23, P24, P25, P26, P27, P28, P29, P30, P31, P32, P33, P34, P35, P36, P37, P38, P39, P40, P41, "
            strSql += "   P42, P43, P44, P45, P46, P47, P48, P49, P50, P51, P52, P53, P54, P55, P56, P57, P58, P59, P60, P61, P62, P63, P64, P65, P66, P67, P68, P69, P70, P71, P72, P73, P102) "
            ...
            strSql += "@P42,@P43,@P44,@P45,@P46,@P47,@P48,@P49,@P50,@P51,@P52,@P53,@P54,@P55,@P56,@P57,@P58,@P59,@P60,@P61,@P62,@P63,@P64,@P65,@P66,@P67,@P68,@P69,@P70,@P71,@P72,@P73,'CL_A_2')"
            ...
            cmd.Parameters.Add("@P102", SqlDbType.NVarChar, 50, "P102")
    ...
    Private Function _Refresh1() As Boolean
        Try
            ...
            Dim da As New SqlClient.SqlDataAdapter(sql, cn)
            Dim ds As New DataSet
            da.Fill(ds, "C_Sin_Test1")
            '   ds.Tables("C_Output_Production").Columns(0).ColumnName = " الموديل "
            ds.Tables("C_Sin_Test1").Columns(0).ColumnName = " الكمية"
            dg2.DataSource = ds.Tables("C_Sin_Test1")
    ...
    Private Function _Refresh11() As Boolean
        Try
            ...
            '   ds.Tables("C_Output_Production").Columns(0).ColumnName = " الموديل "
            ds.Tables("C_Sin_Test1").Columns(0).ColumnName = " الكمية"
            DGH.DataSource = ds.Tables("C_Sin_Test1")
    ...
    Private Sub Button9_Click_1(sender As Object, e As EventArgs) Handles Button9.Click
        ...
        If TxtheaterTwo.Text.Length = 18 Then
            ...
            Dim dsMax As New DataSet
            Dim Sql = "SELECT S_Serial  FROM  C_Sin_Test1 "
            ...
            If dsMax.Tables(0).Rows.Count > 0 Then
                ...
                Exit Sub
            End If
            Dim Sql1 As String = "INSERT INTO C_Sin_Test1"
    ...
    Private Sub btnSEARCH_Click(sender As Object, e As EventArgs) Handles btnSEARCH.Click
        Dim frm As New aquTestTestQueryShow
        frm.Show()
    End Sub
End Class