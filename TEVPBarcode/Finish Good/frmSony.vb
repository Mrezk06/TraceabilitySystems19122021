...
Public Class frmSony
            ...
            If txtFATSERIAL.Text.Length = 16 Then
                ...
                If e.KeyCode = Keys.Enter Then
                    ...
                    Else
                        ...
                        Sql += "(fLCDBarcode, fLCDSN, fLCDSetID, fNameL,fSap_L,fModel,FEAN_CODE)"
                        Sql += " VALUES ('" & txtFATSERIAL.Text & "','" & Barcode_Part2(2) & "','" & Barcode_Part2(0) & "','" & cmb_Pcode3.Text & "','" & txtS_Laber.Text & "','" & cmb_Pcode.Text & "','" & txteancode.Text & "')"
            ...
            ElseIf txtFATSERIAL.Text.Length = 14 Then
                ...
                If e.KeyCode = Keys.Enter Then
                    ...
                    Else
                        Sql = " INSERT INTO Output "
                        Sql += "(fLCDBarcode, fLCDSN, fLCDSetID, fNameL,fSap_L,fModel,FEAN_CODE)"
                        Sql += " VALUES ('" & txtFATSERIAL.Text & "','" & Barcode_Part(2) & "','" & Barcode_Part(0) & "','" & cmb_Pcode3.Text & "','" & txtS_Laber.Text & "','" & cmb_Pcode.Text & "','" & txteancode.Text & "')"
    ...
    Private Function _Refresh1() As Boolean
        Try
            ...
            Dim ds As New DataSet
            da.Fill(ds, "Output")
            ds.Tables("Output").Columns(0).ColumnName = " LCD Model Name"
    ...
    Private Sub txtDelete_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtDelete.KeyDown
        Try
            If e.KeyCode = Keys.Enter Then
                ...
                'Dim dsMax As New DataSet
                Dim sql As String
                'Dim Sql = "SELECT fLCDBarcode  FROM  Output where fLCDBarcode !='" & txtDelete.Text & "'"
                'Dim da As New SqlClient.SqlDataAdapter(Sql, cn)
                'dsMax.Tables.Clear()
                'da.Fill(dsMax)
                'If dsMax.Tables(0).Rows.Count > 0 Then
                '    lbl_Msg.ForeColor = Color.Red
                '    lbl_Msg.Text = "هذا السيريال غير موجود "
                '    txtDelete.Focus()
                '    txtDelete.SelectAll()
                '    Exit Sub
                'End If
