...
Public Class frmFinishGoodWH3


    '  Public Class frmFinishGoodWH22
    Private Sub txtFATSERIAL_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtFATSERIAL.KeyDown
        ...
        Try
            ...
            If e.KeyCode = Keys.Enter Then
                ...
                Dim Sql1 = "SELECT fLCDBarcode FROM OutputWH2 "
                Sql1 += " where fLCDBarcode='" & txtFATSERIAL.Text & "'"
                Sql1 += " and fModel='" & cmb_Pcode.Text & "'"
            ...
            If txtFATSERIAL.Text.Length = 16 Then
                ...
                If e.KeyCode = Keys.Enter Then
                    ...
                    'If txtFATSERIAL.Text.Length > 14 Then Exit Sub
                    Dim dsMax As New DataSet
                    Dim Sql = "SELECT fLCDBarcode  FROM  OutputWH3 "
                    ...
                    Else
                        ...
                        Sql = " INSERT INTO OutputWH3 "
                        Sql += "(fLCDBarcode, fLCDSN, fLCDSetID, fNameL,fSap_L,fModel, fCustomer,fCompany, fCar, fContainer, fStore_code)"
                        Sql += " VALUES ('" & txtFATSERIAL.Text & "','" & Barcode_Part2(2) & "','" & Barcode_Part2(0) & "','" & cmb_Pcode3.Text & "','" & txtS_Laber.Text & "','" & cmb_Pcode.Text & "','" & txtCustomer.Text & "','" & txtCompany.Text & "','" & txtcar.Text & "','" & txtContainer.Text & "','" & txtStoreCode.Text & "')"
            ...
            ElseIf txtFATSERIAL.Text.Length = 14 Then
                ...
                If e.KeyCode = Keys.Enter Then
                    ...
                    Else
                        ...
                        Sql = "INSERT INTO OutputWH3"
                        Sql += "(fLCDBarcode, fLCDPyear, fLCDPweek, fLCDSetID, fLCDCountry, fLCDPline, fLCDSN, fLCDPID, fNameL,fSap_L,fModel, fCustomer,fCompany, fCar, fContainer, fStore_code)"
                        Sql += "VALUES     ('"
                        Sql += txtFATSERIAL.Text & "',"
                        For i As Integer = 0 To Barcode_Part.Length - 1
                            Sql += "'" & Barcode_Part(i) & "',"
                        ...
                        Sql += "'" & cmb_Pcode3.Text & "',"
                        Sql += "'" & txtS_Laber.Text & "',"
                        Sql += "'" & cmb_Pcode.Text & "','" & txtCustomer.Text & "','" & txtCompany.Text & "','" & txtcar.Text & "','" & txtContainer.Text & "','" & txtStoreCode.Text & "')"
            ...
            ElseIf txtFATSERIAL.Text.Length = 11 Then
                If e.KeyCode = Keys.Enter Then
                    ...
                    Else
                        ...
                        Sql = " INSERT INTO OutputWH3 "
                        Sql += "(fLCDBarcode, fLCDSN, fLCDSetID, fNameL,fSap_L,fModel, fCustomer,fCompany, fCar, fContainer, fStore_code)"
                        Sql += " VALUES ('" & txtFATSERIAL.Text & "','" & Barcode_Part(1) & "','" & Barcode_Part(0) & "','" & cmb_Pcode3.Text & "','" & txtS_Laber.Text & "','" & cmb_Pcode.Text & "','" & txtCustomer.Text & "','" & txtCompany.Text & "','" & txtcar.Text & "','" & txtContainer.Text & "','" & txtStoreCode.Text & "')"
    ...
    Private Function _Refresh1() As Boolean
        Try
            Dim sql As String = ""
            sql += " SELECT fModel,count(fLCDBarcode) FROM OutputWH3"
            ...
            dg2.DataSource = ds.Tables("OutputWH3")
            Return True
        Catch ex As Exception
        End Try
    End Function
    Private Function _Refresh13() As Boolean
        Try
            ...
            dg5.DataSource = ds.Tables("OutputWH3")
            Return True
        Catch ex As Exception
        End Try
    End Function
