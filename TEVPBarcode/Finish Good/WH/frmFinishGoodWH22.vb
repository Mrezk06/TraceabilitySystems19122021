...
Public Class frmFinishGoodWH22
    Private Sub txtFATSERIAL_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtFATSERIAL.KeyDown
        ...
        Try
            ...
            '    Dim Sql1 = "SELECT [fLCDBarcode]FROM [barcode].[dbo].[OutputWH1] where fLCDBarcode = '" & txtFATSERIAL.Text & "'"
            ...
            If txtFATSERIAL.Text.Length = 16 Then
                ...
                If e.KeyCode = Keys.Enter Then
                    ...
                    'If txtFATSERIAL.Text.Length > 14 Then Exit Sub
                    Dim dsMax As New DataSet
                    Dim Sql = "SELECT fLCDBarcode  FROM  OutputWH2 "
    ...
    Private Function _Refresh1() As Boolean
        Try
            Dim sql As String = ""
            sql += " SELECT fModel,count(fLCDBarcode) FROM OutputWH2"
            ...
            dg2.DataSource = ds.Tables("OutputWH2")
            Return True
        Catch ex As Exception
        End Try
    End Function
    Private Function _Refresh13() As Boolean
        Try
            ...
            dg5.DataSource = ds.Tables("OutputWH2")
            Return True
        Catch ex As Exception
        End Try
    End Function
    ...
    Private Sub btnSEARCH_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSEARCH.Click
        Dim frm1 As New frmQFinishGoodWH2
        frm1.Show()
    End Sub
